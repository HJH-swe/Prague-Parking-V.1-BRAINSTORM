...
// men vi kan skrota den om nån annan redan har börjat eller har en bättre design!
...
try
{
    ...
    switch (menuSelect)
    {
        case 1:
            {
                // Fyll på med kod - parkera fordon
                Console.WriteLine("Test. meny 1");
                break;
            }
        case 2:
            {
                // Fyll på med kod - flytta ett fordon.
                // t.ex. flytta ihop MC
        ...
        case 3:
            {
                // Fyll på med kod - söka efter fordon.
        ...
        case 4:
            {
                // Fyll på med kod - hämta ut fordon.
        ...
        case 5:
            {
                // Fyll på med kod - avsluta programmet
        ...
        default:
            {
                Console.WriteLine("Ogiltigt menyval. Välj genom att trycka 1-4 på siffertangenterna.\n\n");
                break;
            }
    }
}
